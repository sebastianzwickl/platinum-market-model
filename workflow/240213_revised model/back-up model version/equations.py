...
def add_equation_54_1(model=None):
    model.eq_54_1 = py.Constraint(
        model.set_e, model.set_t, rule=eq_54_1, doc="Equation 54 (1)."
    )
    return
...
def add_equation_54_2_lower(model=None):
    model.eq_54_2_lower = py.Constraint(
        model.set_e, model.set_t, rule=eq_54_2_lower, doc="Equation 54 (2; lower)."
    )
...
def add_equation_54_2_upper(model=None):
    model.eq_54_2_upper = py.Constraint(
        model.set_e, model.set_t, rule=eq_54_2_upper, doc="Equation 54 (2; upper)."
    )
    return
...
def add_18(model=None):
    ...
    model.set_segments_points = py.Set(
        initialize=[0, 1], doc="each segment has a starting and an ending point."
    )  # checked
...
def eq_18_x_axis(model, e, t):
    if e == "Recycling":
        ...
        return (
            ...
            + (_lambda_snake_1 - _lambda_snake_0)
            * model.var_delta_seg_points[e, t, 1, 0]
...
def eq_18_y_axis(model, e, t):
    if e in ["Recycling", "Slack exporter"]:
        ...
        return model.var_q_bar_add[e, t] <= _max_increase_per_year * (
            model.var_delta_seg_points[e, t, 1, 0] + model.var_delta_seg[e, t, 2]
        )
...
def feasible_constraint(model=None):
    ...
    return _first_term - _second_term <= 10e15
